    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        <img
          src={profileImage}
          alt="Profile"
          className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover ring-2 ring-neutral-700"
        />
        <div className="text-center md:text-left">
          <h1 className="text-5xl font-bold tracking-tight transition-transform duration-300 hover:scale-[1.02]">
            Dimpal Goyal <span className="text-xl text-neutral-500 font-normal">· he/him</span>
          </h1>
          <p className="mt-2 text-lg text-neutral-400">Software Engineer</p>
          ...
          <div className="mt-8 flex items-center justify-center md:justify-start gap-6">
            <a
              ...
              className="text-neutral-400 hover:text-white transition-all duration-200 hover:scale-110 inline-block"
            >
              <GitHubIcon />
            </a>
            <a
